...
- A person's messages are part of their data download (photos are marked `photo: true`), and deleting an account deletes their conversations with every message and photo in them.
