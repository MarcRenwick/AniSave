      ...
      <div className="mx-auto max-w-2xl space-y-6 p-8">
          ...
          <form onSubmit={handleProfileSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={inputClass}
              />
              <p className="mt-1 text-xs text-gray-400">Used for recommendations and delivery fee estimates.</p>
            </div>
        ...
        <SettingsCard title="Delete Account">
          <p className="text-sm text-gray-600">
            Permanently delete your account and your order history. This cannot be undone.
          </p>
          <button
            type="button"
